...
if ( !AmCharts.translations[ "export" ][ "en" ] ) {
	AmCharts.translations[ "export" ][ "en" ] = {
		...
		"capturing.delayed.menu.title": "برای انصراف کلیلک کنید",

		"menu.label.print": "پرینت",
		"menu.label.undo": "واچیدن",
		"menu.label.redo": "باز چینی",
		"menu.label.cancel": "بستن",

		"menu.label.save.image": "خروجی تصویر...",
		"menu.label.save.data": "خروجی داده ها...",

		"menu.label.draw": "حاشیه نویسی ...",
		"menu.label.draw.change": "تغییر ...",
		"menu.label.draw.add": "اضافه ...",
		"menu.label.draw.shapes": "شکل ...",
		"menu.label.draw.colors": "رنگ ...",
		"menu.label.draw.widths": "ابعاد ...",
		"menu.label.draw.opacitie": "تاری ...",
		"menu.label.draw.text": "متن",

		"menu.label.draw.modes": "حالت ...",
		"menu.label.draw.modes.pencil": "مداد",
		"menu.label.draw.modes.line": "خط",
		"menu.label.draw.modes.arrow": "پیکان"
	}
}
