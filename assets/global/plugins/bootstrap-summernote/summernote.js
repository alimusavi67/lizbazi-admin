...
(function (factory) {
 ...
 $.extend($.summernote.lang, {
    'fa-IR': {
      ...
      help: {
        'insertParagraph': 'ثبت پاراگراف',
        'undo': 'واچیدن آخرین فرمان',
        'redo': 'بازچیدن انجام آخرین فرمان',
        'tab': 'تب',
        'untab': 'آن تب',
        'bold': 'ثبت استایل درشت',
        'italic': 'ثبت استایل ایتالیک',
        'underline': 'ثبت استایل میان خط',
        'strikethrough': 'ثبت استایل strikethrough',
        ...
        'insertUnorderedList': 'ثبت لیست نشانه ای',
        'insertOrderedList': 'ثبت لیست شمارشی',
        'outdent': 'افزایش تو رفتگی در پاراگراف جاری',
        'indent': 'کاهش تو رفتگی در پاراگراف جاری',
        'formatPara': 'تغییر فرمت بلاک جاری به شکل پاراگراف(P tag)',
        'formatH1': 'تغییر فرمت بلاک جاری به شکل H1',
        'formatH2': 'تغییر فرمت بلاک جاری به شکل H2',
        'formatH3': 'تغییر فرمت بلاک جاری به شکل H3',
        'formatH4': 'تغییر فرمت بلاک جاری به شکل H4',
        'formatH5': 'تغییر فرمت بلاک جاری به شکل H5',
        'formatH6': 'تغییر فرمت بلاک جاری به شکل H6',
        'insertHorizontalRule': 'رفتن به خط جدید',
        'linkDialog.show': 'نمایش دیالوگ لینکی'
      },
      history: {
        undo: 'واچیدن',
        redo: 'بازچیدن'
      ...
      specialChar: {
        specialChar: 'کاراکتر های ویژه',
        select: 'یک کاراکتر ویژه انتخاب کنید'
      }
    }
  });
  /**
  ...
  var HelpDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = [
        '<p class="text-center">',
        '<a href="//farazpardazan.com//" target="_blank">فراز پردازان</a> · ',
        '<a href="//farazpardazan.com" target="_blank">نسخه 1.0.0</a>',
        '</p>'
      ].join('');
